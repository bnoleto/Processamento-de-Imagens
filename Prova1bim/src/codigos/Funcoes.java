...
public class Funcoes {
	...
	// abre a imagem original no desktop pra compara��o
	...
	public void executar(String filename, int angulo) {
		...
		// ir� pegar o caminho da imagem original e usar� a fun��o do openCV pra armazenar no Mat
